...
const helpers = {
  getExtParamsFromBid(bid) {
    ...
    if ((0,_src_utils_js__WEBPACK_IMPORTED_MODULE_3__.isPlainObject)(bid.params.render)) {
  ...
  getViewability(bid) {
    try {
      ...
      if (!element) return;
      const viewabilityAmount = (0,_libraries_percentInView_percentInView_js__WEBPACK_IMPORTED_MODULE_12__.isViewabilityMeasurable)(element) ? (0,_libraries_percentInView_percentInView_js__WEBPACK_IMPORTED_MODULE_12__.getViewability)(element, (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_4__.getWindowTop)(), size) : 'na';
  ...
  createOrtbImpVideoObj(bid) {
    var _bid$sizes;
    const video = (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_5__["default"])(bid, 'mediaTypes.video');
    if (!video) return;
  ...
  getFloor(bid) {
    ...
    if ((0,_src_utils_js__WEBPACK_IMPORTED_MODULE_3__.isPlainObject)(floorInfo) && floorInfo.currency === DEFAULT_CURRENCY && !isNaN(parseFloat(floorInfo.floor))) {
...
function createOpenRtbRequest(validBidRequests, bidderRequest) {
  ...
  const schain = (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_5__["default"])(validBidRequests, '0.ortb2.source.ext.schain');
  if (schain) request.source.ext = {
    schain: schain
  };

  // Set Eids
  const eids = (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_5__["default"])(validBidRequests, '0.userIdAsEids');
  if (eids && eids.length) {
    (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_6__.dset)(request, 'user.ext.eids', eids);
  }
  ...
  const pageUrl = (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_5__["default"])(bidderRequest, 'refererInfo.page');
  const accountId = (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_5__["default"])(validBidRequests[0], 'params.accountId');
  (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_6__.dset)(request, 'site.page', pageUrl);
  (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_6__.dset)(request, 'site.publisher.id', accountId);
  ...
  if (bidderRequest.gdprConsent) {
    ...
    (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_6__.dset)(request, 'user.ext.consent', bidderRequest.gdprConsent.consentString);
  }
  (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_6__.dset)(request, 'regs.ext.gdpr', gdprApplies);
  if (GET_CONFIG('coppa') === true) (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_6__.dset)(request, 'regs.coppa', 1);
  if (bidderRequest.uspConsent) {
    (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_6__.dset)(request, 'regs.ext.us_privacy', bidderRequest.uspConsent);
  }

  // Create imps with bids
  validBidRequests.forEach(bid => {
    const bannerObj = (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_5__["default"])(bid.mediaTypes, "banner");
    const videoObj = (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_5__["default"])(bid.mediaTypes, "video");
    const imp = {
      id: bid.bidId,
...
/******/ __webpack_require__ => { // webpackRuntimeModules
/******/ var __webpack_exec__ = (moduleId) => (__webpack_require__(__webpack_require__.s = moduleId))
/******/ __webpack_require__.O(0, ["percentInView","boundingClientRect","chunk-core","viewport","dnt","creative-renderer-display"], () => (__webpack_exec__("./modules/impactifyBidAdapter.js")));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ }
]);
