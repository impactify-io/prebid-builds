...
/* harmony export */   _filterBidsForAdUnit: () => (/* binding */ _filterBidsForAdUnit),
  ...
  return adUnits.reduce((result, adUnit) => {
    ...
    result.push(bids.reduce((bids, bid) => {
      ...
      if ((0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.isValidMediaTypes)(mediaTypes)) {
        ...
        (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.logError)(`mediaTypes is not correctly configured for adunit ${adUnit.code}`);
      }
      if (src === 'client') {
...
adapterManager.makeBidRequests = (0,_hook_js__WEBPACK_IMPORTED_MODULE_8__.hook)('sync', function (adUnits, auctionStart, auctionId, cbTimeout, labels) {
  ...
  clientBidders.forEach(bidderCode => {
    ...
    if (!adapter) {
      (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.logError)(`Trying to make a request for bidder that does not exist: ${bidderCode}`);
    }
...
adapterManager.callBids = function (adUnits, bidRequests, addBidResponse, doneCb, requestCallbacks, requestBidsTimeout, onTimelyResponse) {
    ...
    if (s2sConfig && uniqueServerBidRequests[counter] && getS2SBidderSet(s2sConfig).has(uniqueServerBidRequests[counter].bidderCode)) {
      ...
      if (s2sAdapter) {
        ...
        if (s2sBidRequest.ad_units.length) {
          ...
          (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.logMessage)(`CALLING S2S HEADER BIDDERS ==== ${bidders.length > 0 ? bidders.join(', ') : 'No bidder specified, using "ortb2Imp" definition(s) only'}`);
  ...
  clientBidderRequests.forEach(bidderRequest => {
    ...
    try {
      ...
      (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.logError)(`${bidderRequest.bidderCode} Bid Adapter emitted an uncaught error when parsing their bidRequest`, {
        e,
      ...
      try {
        ...
        if (bidAdapter.constructor.prototype != Object.prototype) {
          ...
          if (gvlid == null && spec.gvlid != null) {
            (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.logWarn)(`Alias '${alias}' will NOT re-use the GVL ID of the original adapter ('${spec.code}', gvlid: ${spec.gvlid}). Functionality that requires TCF consent may not work as expected.`);
          }
...
adapterManager.registerAnalyticsAdapter = function (_ref2) {
  ...
  if (adapter && code) {
    if (typeof adapter.enableAnalytics === 'function') {
      ...
      (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.logError)(`Prebid Error: Analytics adaptor error for analytics "${code}"
...
adapterManager.enableAnalytics = function (config) {
  ...
  config.forEach(adapterConfig => {
    ...
    if (entry && entry.adapter) {
      ...
      (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.logError)(`Prebid Error: no analytics adapter found in registry for '${adapterConfig.provider}'.`);
    }
  });
};
...
function invokeBidderMethod(bidder, method, spec, fn) {
  try {
    (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.logInfo)(`Invoking ${bidder}.${method}`);
    ...
    (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.logWarn)(`Error calling ${method} of ${bidder}`);
  }
}
...
adapterManager.triggerBilling = (() => {
  ...
  return bid => {
    if (!BILLED.has(bid)) {
      BILLED.add(bid);
      ((0,_eventTrackers_js__WEBPACK_IMPORTED_MODULE_18__.parseEventTrackers)(bid.eventtrackers)[_eventTrackers_js__WEBPACK_IMPORTED_MODULE_18__.EVENT_TYPE_IMPRESSION]?.[_eventTrackers_js__WEBPACK_IMPORTED_MODULE_18__.TRACKER_METHOD_IMG] || []).forEach(url => _utils_js__WEBPACK_IMPORTED_MODULE_4__.internal.triggerPixel(url));
  ...
  Object.entries(_analyticsRegistry).forEach(_ref3 => {
    ...
    if (typeof fn === 'function') {
      try {
        ...
        (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.logError)(`error calling ${method} of ${name}`, e);
      }
    }
  });
});
