/* prebid.js v9.39.0-pre
Updated: 2025-04-10
Modules: impactifyBidAdapter, tcfControl, consentManagementGpp, consentManagementTcf, gppControl_usstates, gptPreAuction, bidResponseFilter, debugging */
...
adapterManager.triggerBilling = (() => {
  ...
  return bid => {
    if (!BILLED.has(bid)) {
      BILLED.add(bid);
      ((0,_eventTrackers_js__WEBPACK_IMPORTED_MODULE_18__.parseEventTrackers)(bid.eventtrackers)[_eventTrackers_js__WEBPACK_IMPORTED_MODULE_18__.EVENT_TYPE_IMPRESSION]?.[_eventTrackers_js__WEBPACK_IMPORTED_MODULE_18__.TRACKER_METHOD_IMG] || []).forEach(url => _utils_js__WEBPACK_IMPORTED_MODULE_3__.internal.triggerPixel(url));
...
function tryAddVideoBid(auctionInstance, bidResponse, afterBidAdded) {
  ...
  if (useLocal) {
    ...
    (0,_videoCache_js__WEBPACK_IMPORTED_MODULE_16__.storeLocally)(bidResponse);
  } else if (cacheUrl && (useCacheKey || context !== _video_js__WEBPACK_IMPORTED_MODULE_17__.OUTSTREAM)) {
...
/* harmony import */ var _secureCreatives_js__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./secureCreatives.js */ "./src/secureCreatives.js");
...
/* harmony import */ var _bidfactory_js__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./bidfactory.js */ "./src/bidfactory.js");
...
/* harmony import */ var _adapterManager_js__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./adapterManager.js */ "./src/adapterManager.js");
/* harmony import */ var _constants_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./constants.js */ "./src/constants.js");
/* harmony import */ var _events_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./events.js */ "./src/events.js");
/* harmony import */ var _utils_perfMetrics_js__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./utils/perfMetrics.js */ "./src/utils/perfMetrics.js");
...
/* harmony import */ var _mediaTypes_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./mediaTypes.js */ "./src/mediaTypes.js");
/* harmony import */ var _utils_prerendering_js__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./utils/prerendering.js */ "./src/utils/prerendering.js");
/* harmony import */ var _adapters_bidderFactory_js__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./adapters/bidderFactory.js */ "./src/adapters/bidderFactory.js");
/** @module pbjs */
...
pbjsInstance.version = "v9.39.0-pre";
(0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.logInfo)("Prebid.js v9.39.0-pre loaded");
...
pbjsInstance.requestBids = function () {
  const delegate = (0,_hook_js__WEBPACK_IMPORTED_MODULE_11__.hook)('async', function () {
    ...
    return (0,_fpd_enrichment_js__WEBPACK_IMPORTED_MODULE_19__.enrichFPD)(_utils_promise_js__WEBPACK_IMPORTED_MODULE_20__.PbPromise.resolve(ortb2Fragments.global)).then(global => {
  ...
  return (0,_hook_js__WEBPACK_IMPORTED_MODULE_11__.wrapHook)(delegate, (0,_utils_prerendering_js__WEBPACK_IMPORTED_MODULE_21__.delayIfPrerendering)(() => !_config_js__WEBPACK_IMPORTED_MODULE_17__.config.getConfig('allowPrerendering'), function requestBids() {
    ...
    req.metrics = (0,_utils_perfMetrics_js__WEBPACK_IMPORTED_MODULE_22__.newMetrics)();
...
const startAuction = (0,_hook_js__WEBPACK_IMPORTED_MODULE_11__.hook)('async', function () {
  ...
  const s2sBidders = (0,_adapterManager_js__WEBPACK_IMPORTED_MODULE_23__.getS2SBidderSet)(_config_js__WEBPACK_IMPORTED_MODULE_17__.config.getConfig('s2sConfig') || []);
  fillAdUnitDefaults(adUnits);
  adUnits = (0,_utils_perfMetrics_js__WEBPACK_IMPORTED_MODULE_22__.useMetrics)(metrics).measureTime('requestBids.validate', () => checkAdUnitSetup(adUnits));
  ...
  adUnits.forEach(adUnit => {
    ...
    const bidderRegistry = _adapterManager_js__WEBPACK_IMPORTED_MODULE_23__["default"].bidderRegistry;
...
pbjsInstance.registerBidAdapter = function (bidderAdaptor, bidderCode, spec) {
  ...
  try {
    const bidder = spec ? (0,_adapters_bidderFactory_js__WEBPACK_IMPORTED_MODULE_25__.newBidder)(spec) : bidderAdaptor();
    _adapterManager_js__WEBPACK_IMPORTED_MODULE_23__["default"].registerBidAdapter(bidder, bidderCode);
  } catch (e) {
...
pbjsInstance.registerAnalyticsAdapter = function (options) {
  ...
  try {
    _adapterManager_js__WEBPACK_IMPORTED_MODULE_23__["default"].registerAnalyticsAdapter(options);
  } catch (e) {
...
pbjsInstance.createBid = function (statusCode) {
  ...
  return (0,_bidfactory_js__WEBPACK_IMPORTED_MODULE_26__.createBid)(statusCode);
};
...
const enableAnalyticsCb = (0,_hook_js__WEBPACK_IMPORTED_MODULE_11__.hook)('async', function (config) {
  if (config && !(0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.isEmpty)(config)) {
    ...
    _adapterManager_js__WEBPACK_IMPORTED_MODULE_23__["default"].enableAnalytics(config);
  } else {
...
pbjsInstance.aliasBidder = function (bidderCode, alias, options) {
  ...
  if (bidderCode && alias) {
    _adapterManager_js__WEBPACK_IMPORTED_MODULE_23__["default"].aliasBidAdapter(bidderCode, alias, options);
  } else {
 ...
 */
pbjsInstance.aliasRegistry = _adapterManager_js__WEBPACK_IMPORTED_MODULE_23__["default"].aliasRegistry;
...
pbjsInstance.que.push(() => (0,_secureCreatives_js__WEBPACK_IMPORTED_MODULE_27__.listenMessagesFromCreative)());
 ...
 */
pbjsInstance.processQueue = (0,_utils_prerendering_js__WEBPACK_IMPORTED_MODULE_21__.delayIfPrerendering)(() => (0,_prebidGlobal_js__WEBPACK_IMPORTED_MODULE_0__.getGlobal)().delayPrerendering, function () {
...
pbjsInstance.triggerBilling = _ref7 => {
  ...
  _auctionManager_js__WEBPACK_IMPORTED_MODULE_5__.auctionManager.getAllWinningBids().filter(bid => bid.adId === adId || adId == null && bid.adUnitCode === adUnitCode).forEach(bid => {
    _adapterManager_js__WEBPACK_IMPORTED_MODULE_23__["default"].triggerBilling(bid);
...
function newTargeting(auctionManager) {
  ...
  function getTargetingLevels(bidsSorted, customKeysByUnit, adUnitCodes) {
    const useAllBidsCustomTargeting = _config_js__WEBPACK_IMPORTED_MODULE_5__.config.getConfig('targetingControls.allBidsCustomTargeting') !== false;
  ...
  targeting.getWinningBids = function (adUnitCode, bids) {
    ...
    const adUnitCodes = getAdUnitCodes(adUnitCode);
    return bidsReceived.filter(bid => (0,_polyfill_js__WEBPACK_IMPORTED_MODULE_3__.includes)(adUnitCodes, bid.adUnitCode)).filter(bid => _bidderSettings_js__WEBPACK_IMPORTED_MODULE_8__.bidderSettings.get(bid.bidderCode, 'allowZeroCpmBids') === true ? bid.cpm >= 0 : bid.cpm > 0).map(bid => bid.adUnitCode).filter(_utils_js__WEBPACK_IMPORTED_MODULE_2__.uniques).map(adUnitCode => bidsReceived.filter(bid => bid.adUnitCode === adUnitCode ? bid : null).reduce(_utils_reducers_js__WEBPACK_IMPORTED_MODULE_7__.getHighestCpm));
  };
...
/* harmony export */ });
/* unused harmony exports resetWinDimensions, getPrebidInternal, getBidIdParameter, sizesToSizeTuples, sizeTupleToSizeString, parseGPTSingleSizeArray, sizeTupleToRtbSize, parseGPTSingleSizeArrayToRtbSize, getWindowLocation, canAccessWindowTop, hasConsoleLogger, debugTurnedOn, isA, _each, contains, _map, waitForElementToLoad, createTrackPixelHtml, encodeMacroURI, createTrackPixelIframeHtml, getBidRequest, getValue, isSafeFrameWindow, getSafeframeGeometry, replaceAuctionPrice, replaceClickThrough, getDomLoadingDuration, cleanObj, parseQS, formatQS, safeJSONParse, safeJSONEncode, getUnixTimestampFromNow, convertObjectToArray, setOnAny, extractDomainFromHost, triggerNurlWithCpm */
/* harmony import */ var _config_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./config.js */ "./src/config.js");
...
/******/ __webpack_require__.O(0, ["chunk-core","viewport","greedy","creative-renderer-display"], () => (__webpack_exec__("./modules/bidResponseFilter/index.js")));
...
/******/ __webpack_require__ => { // webpackRuntimeModules
/******/ var __webpack_exec__ = (moduleId) => (__webpack_require__(__webpack_require__.s = moduleId))
/******/ __webpack_require__.O(0, ["chunk-core","consentManagement","cmp","viewport","greedy","creative-renderer-display"], () => (__webpack_exec__("./modules/consentManagementTcf.js")));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ }
]);
