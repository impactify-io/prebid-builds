    ...
    serverBody.seatbid.forEach(seatbid => {
      if (seatbid.bid.length) {
        bidResponses.push(...seatbid.bid.filter(bid => bid.price > 0).map(bid => {
          ...
          const isInstream = ((_impMap$bid$impid = impMap[bid.impid]) === null || _impMap$bid$impid === void 0 || (_impMap$bid$impid = _impMap$bid$impid.video) === null || _impMap$bid$impid === void 0 ? void 0 : _impMap$bid$impid.context) === 'instream';
