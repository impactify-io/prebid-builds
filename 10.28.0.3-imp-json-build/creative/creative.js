...
function isPrebidWindow(win) {
  return !!win.frames[_constants_js__WEBPACK_IMPORTED_MODULE_0__.PB_LOCATOR];
}
  ...
  return function (_ref2) {
    ...
    function onError(e) {
      sendMessage(_constants_js__WEBPACK_IMPORTED_MODULE_1__.MESSAGE_EVENT, {
        event: _constants_js__WEBPACK_IMPORTED_MODULE_1__.EVENT_AD_RENDER_FAILED,
        info: {
          reason: (e === null || e === void 0 ? void 0 : e.reason) || _constants_js__WEBPACK_IMPORTED_MODULE_1__.ERROR_EXCEPTION,
    ...
    function onMessage(ev) {
      ...
      if (data.message === _constants_js__WEBPACK_IMPORTED_MODULE_1__.MESSAGE_RESPONSE && data.adId === adId) {
        ...
        renderer.onload = guard(function () {
          ...
          W.Promise.resolve(W.render(data, {
            sendMessage,
            mkFrame
          }, win)).then(() => sendMessage(_constants_js__WEBPACK_IMPORTED_MODULE_1__.MESSAGE_EVENT, {
            event: _constants_js__WEBPACK_IMPORTED_MODULE_1__.EVENT_AD_RENDER_SUCCEEDED
          }), onError);
        });
    ...
    sendMessage(_constants_js__WEBPACK_IMPORTED_MODULE_1__.MESSAGE_REQUEST, {
      options: {
        clickUrl
      }
    }, onMessage);
