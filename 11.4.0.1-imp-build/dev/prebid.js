...
pbjsInstance.version = "v11.4.0-pre";
(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.logInfo)("Prebid.js v11.4.0-pre loaded");
...
function logInvocation(name, fn) {
  return function () {
    ...
    (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.logInfo)(`Invoking ${(0,_buildOptions_js__WEBPACK_IMPORTED_MODULE_29__.getGlobalVarName)()}.${name}`, args);
...
const enableAnalyticsCb = (0,_hook_js__WEBPACK_IMPORTED_MODULE_10__.hook)('async', function (config) {
  if (config && !(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(config)) {
    ...
    (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.logError)(`${(0,_buildOptions_js__WEBPACK_IMPORTED_MODULE_29__.getGlobalVarName)()}.enableAnalytics should be called with option {}`);
  }
}, 'enableAnalyticsCb');
...
function aliasBidder(bidderCode, alias, options) {
  if (bidderCode && alias) {
    ...
    (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.logError)('bidderCode and alias must be passed as arguments', `${(0,_buildOptions_js__WEBPACK_IMPORTED_MODULE_29__.getGlobalVarName)()}.aliasBidder`);
  }
}
...
function quePush(command) {
  queSetupComplete.promise.then(() => {
    if (typeof command === 'function') {
      ...
      (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.logError)(`Commands written into ${(0,_buildOptions_js__WEBPACK_IMPORTED_MODULE_29__.getGlobalVarName)()}.cmd.push must be wrapped in a function`);
    }
  });
}
...
function _processQueue(queue, cb) {
  (0,_utils_yield_js__WEBPACK_IMPORTED_MODULE_30__.yieldAll)(() => (0,_prebidGlobal_js__WEBPACK_IMPORTED_MODULE_0__.getGlobal)().yield ?? true, queue.map(cmd => () => runCommand(cmd)), cb);
}
...
/* harmony import */ var _src_prebidGlobal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/prebidGlobal.js */ "./src/prebidGlobal.js");
/* harmony import */ var _libraries_dnt_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../libraries/dnt/index.js */ "./libraries/dnt/index.js");
...
/* harmony import */ var _libraries_percentInView_percentInView_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../libraries/percentInView/percentInView.js */ "./libraries/percentInView/percentInView.js");
...
const helpers = {
  getExtParamsFromBid(bid) {
    ...
    if ((0,_src_utils_js__WEBPACK_IMPORTED_MODULE_5__.isPlainObject)(bid.params.render)) {
  ...
  getViewability(bid) {
    try {
      ...
      if (!element) return;
      const viewabilityAmount = (0,_libraries_percentInView_percentInView_js__WEBPACK_IMPORTED_MODULE_11__.isViewabilityMeasurable)(element) ? (0,_libraries_percentInView_percentInView_js__WEBPACK_IMPORTED_MODULE_11__.getViewability)(element, (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_2__.getWindowTop)(), size) : 'na';
  ...
  createOrtbImpVideoObj(bid) {
    const video = (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_3__["default"])(bid, 'mediaTypes.video');
    if (!video) return;
...
function createOpenRtbRequest(validBidRequests, bidderRequest) {
  ...
  request.device = {
    ...
    js: 1,
    dnt: (0,_libraries_dnt_index_js__WEBPACK_IMPORTED_MODULE_1__.getDNT)() ? 1 : 0,
    language: (navigator?.language || navigator?.userLanguage || '').split('-')[0] || 'en'
  };
  const pageUrl = (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_3__["default"])(bidderRequest, 'refererInfo.page');
  const accountId = (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_3__["default"])(validBidRequests?.[0], 'params.accountId');
  (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_4__.dset)(request, 'site.page', pageUrl);
  (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_4__.dset)(request, 'site.publisher.id', accountId);
...
const spec = {
  ...
  onBidWon: function (bid) {
    (0,_src_ajax_js__WEBPACK_IMPORTED_MODULE_9__.ajax)(`${LOGGER_URI}/prebid/won`, null, JSON.stringify(bid), {
      method: 'POST',
  ...
  onTimeout: function (data) {
    (0,_src_ajax_js__WEBPACK_IMPORTED_MODULE_9__.ajax)(`${LOGGER_URI}/prebid/timeout`, null, JSON.stringify(data[0]), {
      method: 'POST',
      contentType: 'application/json'
    });
    return true;
...
/******/ __webpack_require__ => { // webpackRuntimeModules
/******/ var __webpack_exec__ = (moduleId) => (__webpack_require__(__webpack_require__.s = moduleId))
/******/ __webpack_require__.O(0, ["chunk-core","viewport","creative-renderer-display","percentInView","dnt","boundingClientRect"], () => (__webpack_exec__("./modules/impactifyBidAdapter.js")));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ }
]);
...
_libraries_metadata_metadata_js__WEBPACK_IMPORTED_MODULE_0__.metadata.register("impactifyBidAdapter", {"disclosures":{"https://ad.impactify.io/tcfvendors.json":{"timestamp":"2026-04-02T17:28:37.812Z","disclosures":[{"identifier":"_im*","type":"web","purposes":[3,4,7,10]}]}},"components":[{"componentType":"bidder","componentName":"impactify","disclosureURL":"https://ad.impactify.io/tcfvendors.json"},{"componentType":"bidder","componentName":"imp","aliasOf":"impactify","disclosureURL":null}]})
...
_libraries_metadata_metadata_js__WEBPACK_IMPORTED_MODULE_0__.metadata.register("debugging", {"disclosures":{"https://cdn.jsdelivr.net/gh/prebid/Prebid.js/metadata/disclosures/prebid/debugging.json":{"timestamp":"2026-04-02T17:27:21.619Z","disclosures":[{"identifier":"__*_debugging__","type":"web","purposes":[1]}]}},"components":[{"componentType":"prebid","componentName":"debugging","disclosureURL":"https://cdn.jsdelivr.net/gh/prebid/Prebid.js/metadata/disclosures/prebid/debugging.json"}]})
...
_libraries_metadata_metadata_js__WEBPACK_IMPORTED_MODULE_0__.metadata.register("prebid-core", {"disclosures":{"https://cdn.jsdelivr.net/gh/prebid/Prebid.js/metadata/disclosures/prebid/probes.json":{"timestamp":"2026-04-02T17:27:21.617Z","disclosures":[{"identifier":"_rdc*","type":"cookie","maxAgeSeconds":10,"cookieRefresh":false,"purposes":[1]},{"identifier":"prebid.cookieTest","type":"web","purposes":[1]}]},"https://cdn.jsdelivr.net/gh/prebid/Prebid.js/metadata/disclosures/prebid/debugging.json":{"timestamp":"2026-04-02T17:27:21.617Z","disclosures":[{"identifier":"__*_debugging__","type":"web","purposes":[1]}]}},"components":[{"componentType":"prebid","componentName":"fpdEnrichment","disclosureURL":"https://cdn.jsdelivr.net/gh/prebid/Prebid.js/metadata/disclosures/prebid/probes.json"},{"componentType":"prebid","componentName":"storage","disclosureURL":"https://cdn.jsdelivr.net/gh/prebid/Prebid.js/metadata/disclosures/prebid/probes.json"},{"componentType":"prebid","componentName":"debugging","disclosureURL":"https://cdn.jsdelivr.net/gh/prebid/Prebid.js/metadata/disclosures/prebid/debugging.json"}]})
