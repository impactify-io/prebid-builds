...
/* harmony export */ });
/* harmony import */ var _constants_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants.js */ "./creative/constants.js");
...
const mkFrame = (() => {
  ...
  return (doc, attrs) => {
    ...
    Object.entries(Object.assign({}, attrs, DEFAULTS)).forEach(_ref => {
      let [k, v] = _ref;
...
function isPrebidWindow(win) {
  return !!win.frames[_constants_js__WEBPACK_IMPORTED_MODULE_1__.PB_LOCATOR];
}
function renderer(win) {
  ...
  return function (_ref2) {
    ...
    function sendMessage(type, payload, responseListener) {
      ...
      target.postMessage(JSON.stringify(Object.assign({
        message: type,
        adId
      }, payload)), pubDomain, [channel.port2]);
    }
    function onError(e) {
      sendMessage(_constants_js__WEBPACK_IMPORTED_MODULE_0__.MESSAGE_EVENT, {
        event: _constants_js__WEBPACK_IMPORTED_MODULE_0__.EVENT_AD_RENDER_FAILED,
        info: {
          reason: (e === null || e === void 0 ? void 0 : e.reason) || _constants_js__WEBPACK_IMPORTED_MODULE_0__.ERROR_EXCEPTION,
          message: e === null || e === void 0 ? void 0 : e.message
        }
      });
      // eslint-disable-next-line no-console
      (e === null || e === void 0 ? void 0 : e.stack) && console.error(e);
    }
    function guard(fn) {
      return function () {
        try {
    ...
    function onMessage(ev) {
      ...
      if (data.message === _constants_js__WEBPACK_IMPORTED_MODULE_0__.MESSAGE_RESPONSE && data.adId === adId) {
        ...
        renderer.onload = guard(function () {
          ...
          W.Promise.resolve(W.render(data, {
            sendMessage,
            mkFrame
          }, win)).then(() => sendMessage(_constants_js__WEBPACK_IMPORTED_MODULE_0__.MESSAGE_EVENT, {
            event: _constants_js__WEBPACK_IMPORTED_MODULE_0__.EVENT_AD_RENDER_SUCCEEDED
          }), onError);
        });
        ...
        renderer.srcdoc = "<script>".concat(data.renderer, "</script>");
        win.document.body.appendChild(renderer);
      }
    }
    sendMessage(_constants_js__WEBPACK_IMPORTED_MODULE_0__.MESSAGE_REQUEST, {
      options: {
        clickUrl
      }
    }, onMessage);
