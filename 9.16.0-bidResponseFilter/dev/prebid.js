/* prebid.js v9.17.0-pre
Updated: 2024-10-16
Modules: impactifyBidAdapter, tcfControl, consentManagementGpp, consentManagementTcf, gppControl_usstates, gptPreAuction, bidResponseFilter */
...
pbjsInstance.version = "v9.17.0-pre";
(0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.logInfo)("Prebid.js v9.17.0-pre loaded");
...
function cmpClient(_ref) {
  ...
  if (isDirect) {
    client = function invokeCMPDirect() {
      ...
      return new _src_utils_promise_js__WEBPACK_IMPORTED_MODULE_0__.GreedyPromise((resolve, reject) => {
...
/* harmony export */ });
/* unused harmony exports isSlotMatchingAdUnitCode, getGptSlotForAdUnitCode, getGptSlotInfoForAdUnitCode, subscribeToGamEvent, subscribeToGamSlotRenderEndedEvent */
...
/******/ __webpack_require__ => { // webpackRuntimeModules
/******/ var __webpack_exec__ = (moduleId) => (__webpack_require__(__webpack_require__.s = moduleId))
/******/ __webpack_require__.O(0, ["gptUtils","chunk-core","creative-renderer-display"], () => (__webpack_exec__("./modules/gptPreAuction.js")));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ }
]);
...
function createOpenRtbRequest(validBidRequests, bidderRequest) {
  ...
  let schain = (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_2__["default"])(validBidRequests, '0.schain');
  if (schain) request.source.ext = {
    schain: schain
  };

  // Set Eids
  let eids = (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_2__["default"])(validBidRequests, '0.userIdAsEids');
  if (eids && eids.length) {
  ...
  // Set buyer uid
  (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_3__.dset)(request, 'user.buyeruid', (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_4__.generateUUID)());

  // Create imps with bids
  validBidRequests.forEach(bid => {
    let bannerObj = (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_2__["default"])(bid.mediaTypes, `banner`);
    let imp = {
      id: bid.bidId,
...
/******/ __webpack_require__ => { // webpackRuntimeModules
/******/ var __webpack_exec__ = (moduleId) => (__webpack_require__(__webpack_require__.s = moduleId))
/******/ __webpack_require__.O(0, ["chunk-core","creative-renderer-display"], () => (__webpack_exec__("./modules/impactifyBidAdapter.js")));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ }
]);
