...
/* harmony import */ var _utils_wrapsInBids_js__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./utils/wrapsInBids.js */ "./src/utils/wrapsInBids.js");
...
function newAuction(_ref) {
  ...
  const _bidsReceived = (0,_utils_ttlCollection_js__WEBPACK_IMPORTED_MODULE_20__.ttlCollection)({
    ...
    ttl: bid => {
      const minTTL = (0,_bidTTL_js__WEBPACK_IMPORTED_MODULE_21__.getEffectiveMinBidCacheTTL)(bid);
  ...
  _events_js__WEBPACK_IMPORTED_MODULE_13__.on(_constants_js__WEBPACK_IMPORTED_MODULE_15__.EVENTS.PBS_ANALYTICS, event => {
...
function getMediaTypeGranularity(mediaType, mediaTypes, mediaTypePriceGranularity) {
  if (mediaType && mediaTypePriceGranularity) {
    if ( true && mediaType === _mediaTypes_js__WEBPACK_IMPORTED_MODULE_10__.VIDEO) {
      const context = mediaTypes?.[_mediaTypes_js__WEBPACK_IMPORTED_MODULE_10__.VIDEO]?.context ?? 'instream';
      if (mediaTypePriceGranularity[`${_mediaTypes_js__WEBPACK_IMPORTED_MODULE_10__.VIDEO}-${context}`]) {
        return mediaTypePriceGranularity[`${_mediaTypes_js__WEBPACK_IMPORTED_MODULE_10__.VIDEO}-${context}`];
      }
    }
    ...
    if (_config_js__WEBPACK_IMPORTED_MODULE_6__.config.getConfig('cache.url') && (!bidderCode || _bidderSettings_js__WEBPACK_IMPORTED_MODULE_12__.bidderSettings.get(bidderCode, 'sendStandardTargeting') !== false)) {
      ...
      if (typeof adserverTargeting.find(targetingKeyVal => targetingKeyVal.key === _constants_js__WEBPACK_IMPORTED_MODULE_15__.TARGETING_KEYS.CACHE_HOST) === 'undefined') {
        adserverTargeting.push(createKeyVal(_constants_js__WEBPACK_IMPORTED_MODULE_15__.TARGETING_KEYS.CACHE_HOST, function (bidResponse) {
          return bidResponse?.adserverTargeting?.[_constants_js__WEBPACK_IMPORTED_MODULE_15__.TARGETING_KEYS.CACHE_HOST] || urlInfo.hostname;
        }));
      }
    }
  }
...
function groupByPlacement(bidsByPlacement, bid) {
  if (!bidsByPlacement[bid.adUnitCode]) {
    bidsByPlacement[bid.adUnitCode] = (0,_utils_wrapsInBids_js__WEBPACK_IMPORTED_MODULE_25__.wrapInBids)([]);
  }
...
/* harmony import */ var _utils_wrapsInBids_js__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./utils/wrapsInBids.js */ "./src/utils/wrapsInBids.js");
...
/* harmony import */ var _utils_yield_js__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./utils/yield.js */ "./src/utils/yield.js");
/** @module pbjs */
...
pbjsInstance.version = "v11.6.0-pre";
(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.logInfo)("Prebid.js v11.6.0-pre loaded");
...
function validateOrtbFields(adUnit, type, onInvalidParam) {
  ...
  const ORTB_PARAMS = (type => {
    if (type === _mediaTypes_js__WEBPACK_IMPORTED_MODULE_24__.BANNER) {
      return _banner_js__WEBPACK_IMPORTED_MODULE_23__.ORTB_BANNER_PARAMS;
    }
    if ( true && type === _mediaTypes_js__WEBPACK_IMPORTED_MODULE_24__.AUDIO) {
      return _audio_js__WEBPACK_IMPORTED_MODULE_28__.ORTB_AUDIO_PARAMS;
    }
    if ( true && type === _mediaTypes_js__WEBPACK_IMPORTED_MODULE_24__.VIDEO) {
      return _video_js__WEBPACK_IMPORTED_MODULE_22__.ORTB_VIDEO_PARAMS;
    }
  })(type);
...
function logInvocation(name, fn) {
  return function () {
    ...
    (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.logInfo)(`Invoking ${(0,_buildOptions_js__WEBPACK_IMPORTED_MODULE_30__.getGlobalVarName)()}.${name}`, args);
...
function getBids(type) {
  ...
  return responses.map(bid => bid.adUnitCode).filter(_utils_js__WEBPACK_IMPORTED_MODULE_1__.uniques).map(adUnitCode => responses.filter(bid => bid.auctionId === currentAuctionId && bid.adUnitCode === adUnitCode)).filter(bids => bids && bids[0] && bids[0].adUnitCode).map(bids => {
    return {
      [bids[0].adUnitCode]: (0,_utils_wrapsInBids_js__WEBPACK_IMPORTED_MODULE_29__.wrapInBids)(bids)
    };
...
function getNoBidsForAdUnitCode(adUnitCode) {
  ...
  return (0,_utils_wrapsInBids_js__WEBPACK_IMPORTED_MODULE_29__.wrapInBids)(bids);
}
...
function setTargetingForGPTAsync(adUnit) {
  ...
  _targeting_js__WEBPACK_IMPORTED_MODULE_9__.targeting.setTargetingForGPT(adUnit);
}
...
const enableAnalyticsCb = (0,_hook_js__WEBPACK_IMPORTED_MODULE_10__.hook)('async', function (config) {
  if (config && !(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(config)) {
    ...
    (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.logError)(`${(0,_buildOptions_js__WEBPACK_IMPORTED_MODULE_30__.getGlobalVarName)()}.enableAnalytics should be called with option {}`);
  }
}, 'enableAnalyticsCb');
...
function aliasBidder(bidderCode, alias, options) {
  if (bidderCode && alias) {
    ...
    (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.logError)('bidderCode and alias must be passed as arguments', `${(0,_buildOptions_js__WEBPACK_IMPORTED_MODULE_30__.getGlobalVarName)()}.aliasBidder`);
  }
}
...
function quePush(command) {
  queSetupComplete.promise.then(() => {
    if (typeof command === 'function') {
      ...
      (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.logError)(`Commands written into ${(0,_buildOptions_js__WEBPACK_IMPORTED_MODULE_30__.getGlobalVarName)()}.cmd.push must be wrapped in a function`);
    }
  });
}
...
function _processQueue(queue, cb) {
  (0,_utils_yield_js__WEBPACK_IMPORTED_MODULE_31__.yieldAll)(() => (0,_prebidGlobal_js__WEBPACK_IMPORTED_MODULE_0__.getGlobal)().yield ?? true, queue.map(cmd => () => runCommand(cmd)), cb);
}
...
/* harmony import */ var _targeting_lock_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./targeting/lock.js */ "./src/targeting/lock.js");
...
const isBidNotExpired = bid => bid.responseTimestamp + (0,_bidTTL_js__WEBPACK_IMPORTED_MODULE_1__.getBufferedTTL)(bid) * 1000 > (0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.timestamp)();
...
const isBidNotLocked = bid => !_targeting_lock_js__WEBPACK_IMPORTED_MODULE_11__.lock.isLocked(bid.adserverTargeting);
const filters = {
  isBidNotExpired,
  isUnusedBid,
  isBidNotLocked
...
const getHighestCpmBidsFromBidPool = (0,_hook_js__WEBPACK_IMPORTED_MODULE_6__.hook)('sync', function (bidsReceived, winReducer) {
  ...
  let winSorter = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : _utils_js__WEBPACK_IMPORTED_MODULE_7__.sortByHighestCpm;
  if (!hasModified) {
    const bids = [];
    const dealPrioritization = _config_js__WEBPACK_IMPORTED_MODULE_3__.config.getConfig('sendBidsControl.dealPrioritization');
    // bucket by adUnitcode
    const buckets = (0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.groupBy)(bidsReceived, 'adUnitCode');
    // filter top bid for each bucket by bidder
    Object.keys(buckets).forEach(bucketKey => {
      let bucketBids = [];
      const bidsByBidder = (0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.groupBy)(buckets[bucketKey], 'bidderCode');
...
function getGPTSlotsForAdUnits(adUnitCodes) {
  ...
  return getSlots().reduce((auToSlots, slot) => {
    Object.keys(auToSlots).filter((0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.isAdUnitCodeMatchingSlot)(slot)).forEach(au => auToSlots[au].push(slot));
    return auToSlots;
...
function newTargeting(auctionManager) {
  ...
  const targeting = {
    ...
    getAllTargeting(adUnitCode, bidLimit, bidsReceived) {
      let winReducer = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : _utils_reducers_js__WEBPACK_IMPORTED_MODULE_10__.getHighestCpm;
      let winSorter = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : _utils_js__WEBPACK_IMPORTED_MODULE_7__.sortByHighestCpm;
      ...
      if (auctionKeysThreshold) {
        (0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.logInfo)(`Detected 'targetingControls.auctionKeyMaxChars' was active for this auction; set with a limit of ${auctionKeysThreshold} characters.  Running checks on auction keys...`);
    ...
    setTargetingForGPT: (0,_hook_js__WEBPACK_IMPORTED_MODULE_6__.hook)('sync', function (adUnit) {
      ...
      Object.entries(getGPTSlotsForAdUnits(Object.keys(targetingSet))).forEach(_ref => {
        ...
        slots.forEach(slot => {
          ...
          (0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.logMessage)(`Attempting to set targeting-map for slot: ${slot.getSlotElementId()} with targeting-map:`, targetingSet[targetId]);
          slot.updateTargetingFromMap(Object.assign({}, resetMap, targetingSet[targetId]));
          _targeting_lock_js__WEBPACK_IMPORTED_MODULE_11__.lock.lock(targetingSet[targetId]);
        });
      });
    ...
    getWinningBids(adUnitCode, bids) {
      let winReducer = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _utils_reducers_js__WEBPACK_IMPORTED_MODULE_10__.getHighestCpm;
      let winSorter = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : _utils_js__WEBPACK_IMPORTED_MODULE_7__.sortByHighestCpm;
      const bidsReceived = bids || getBidsReceived(winReducer, winSorter);
      const adUnitCodes = getAdUnitCodes(adUnitCode);
      return bidsReceived.filter(bid => adUnitCodes.includes(bid.adUnitCode)).filter(bid => _bidderSettings_js__WEBPACK_IMPORTED_MODULE_2__.bidderSettings.get(bid.bidderCode, 'allowZeroCpmBids') === true ? bid.cpm >= 0 : bid.cpm > 0).map(bid => bid.adUnitCode).filter(_utils_js__WEBPACK_IMPORTED_MODULE_7__.uniques).map(adUnitCode => bidsReceived.filter(bid => bid.adUnitCode === adUnitCode ? bid : null).reduce(_utils_reducers_js__WEBPACK_IMPORTED_MODULE_10__.getHighestCpm));
    },
    /**
     * @param  adUnitCodes adUnitCode or array of adUnitCodes
    ...
    setTargetingForAst(adUnitCodes) {
      ...
      try {
        ...
        (0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.logError)('unable to reset targeting for AST' + e);
      }
      Object.keys(astTargeting).forEach(targetId => {
        _targeting_lock_js__WEBPACK_IMPORTED_MODULE_11__.lock.lock(astTargeting[targetId]);
        Object.keys(astTargeting[targetId]).forEach(key => {
          (0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.logMessage)(`Attempting to set targeting for targetId: ${targetId} key: ${key} value: ${astTargeting[targetId][key]}`);
  ...
  function getAllowedTargetingKeyValues(targeting, allowedKeys) {
    ...
    (0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.logInfo)(`allowTargetingKeys - allowed keys [ ${allowedKeys.map(k => defaultKeyring[k]).join(', ')} ]`);
    ...
    (0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.logInfo)(`allowTargetingKeys - removed keys [ ${removedKeys.join(', ')} ]`);
  ...
  function getfilteredBidsAndCustomKeys(adUnitCodes, bidsReceived) {
    ...
    const alwaysIncludeDeals = _config_js__WEBPACK_IMPORTED_MODULE_3__.config.getConfig('targetingControls.alwaysIncludeDeals');
    const bidTargetingExclusion = _config_js__WEBPACK_IMPORTED_MODULE_3__.config.getConfig('bidTargetingExclusion');
    ...
    initiallyFilteredBids.forEach(bid => {
      ...
      if (typeof bidTargetingExclusion === 'function') {
        try {
          ...
          (0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.logWarn)(`Error in bidTargetingExclusion function - excluding bid ${bid.bidderCode} [${bid.adUnitCode}]`);
      ...
      if (notExcludedByConfig) {
        ...
        Object.keys(bid.adserverTargeting).filter(getCustomKeys()).forEach(key => {
          ...
          if (data[truncKey]) {
            data[truncKey] = data[truncKey].concat(value).filter(_utils_js__WEBPACK_IMPORTED_MODULE_7__.uniques);
          } else {
            data[truncKey] = value;
          }
  ...
  _config_js__WEBPACK_IMPORTED_MODULE_3__.config.getConfig('targetingControls', function (config) {
    if ((0,_utils_js__WEBPACK_IMPORTED_MODULE_8__["default"])(config, CFG_ALLOW_TARGETING_KEYS) != null && (0,_utils_js__WEBPACK_IMPORTED_MODULE_8__["default"])(config, CFG_ADD_TARGETING_KEYS) != null) {
      (0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.logError)(TARGETING_KEY_CONFIGURATION_ERROR_MSG);
    }
  });
  ...
  function filterTargetingKeys(targeting, auctionKeysThreshold) {
    ...
    return targetingMap.reduce(function (accMap, currMap, index, arr) {
      ...
      if (querySize <= auctionKeysThreshold) {
        ...
        (0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.logInfo)(`AdUnit '${code}' auction keys comprised of ${querySize} characters.  Deducted from running threshold; new limit is ${auctionKeysThreshold}`, targetingCopy[code]);
        accMap[code] = targetingCopy[code];
      } else {
        (0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.logWarn)(`The following keys for adUnitCode '${code}' exceeded the current limit of the 'auctionKeyMaxChars' setting.\nThe key-set size was ${querySize}, the current allotted amount was ${auctionKeysThreshold}.\n`, targetingCopy[code]);
      }
      if (index + 1 === arr.length && Object.keys(accMap).length === 0) {
        (0,_utils_js__WEBPACK_IMPORTED_MODULE_7__.logError)('No auction targeting keys were permitted due to the setting in setConfig(targetingControls.auctionKeyMaxChars).  Please review setup and consider adjusting.');
      }
      return accMap;
    }, {});
  }
  ...
  function getBidsReceived() {
    let winReducer = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _utils_reducers_js__WEBPACK_IMPORTED_MODULE_10__.getOldestHighestCpmBid;
  ...
  function getStandardKeys() {
    ...
    .map(targeting => targeting.key).concat(TARGETING_KEYS_ARR).filter(_utils_js__WEBPACK_IMPORTED_MODULE_7__.uniques); // standard keys defined in the library.
  }
  ...
  function getVersionTargeting(adUnitCodes) {
    ...
    return adUnitCodes.map(au => ({
      [au]: [{
        [_constants_js__WEBPACK_IMPORTED_MODULE_4__.TARGETING_KEYS.VERSION]: [version ?? DEFAULT_HB_VER]
      }]
    }));
  }
  function getAdUnitTargeting(adUnitCodes) {
    function getTargetingObj(adUnit) {
      return adUnit?.[_constants_js__WEBPACK_IMPORTED_MODULE_4__.JSON_MAPPING.ADSERVER_TARGETING];
    }
...
if (true) {
  _config_js__WEBPACK_IMPORTED_MODULE_1__.config.getConfig('cache', _ref2 => {
    let {
      cache
    } = _ref2;
    ...
    serverBody.seatbid.forEach(seatbid => {
      if (seatbid?.bid?.length) {
        bidResponses.push(...seatbid.bid.filter(bid => bid.price > 0).map(bid => {
          ...
          const mediaType = impMap[bid.impid]?.video ? 'video' : 'banner';
          return {
            id: bid.id,
            requestId: bid.impid,
            cpm: bid.price,
...
_libraries_metadata_metadata_js__WEBPACK_IMPORTED_MODULE_0__.metadata.register("impactifyBidAdapter", {"disclosures":{"https://ad.impactify.io/tcfvendors.json":{"timestamp":"2026-04-13T18:09:10.180Z","disclosures":[{"identifier":"_im*","type":"web","purposes":[3,4,7,10]}]}},"components":[{"componentType":"bidder","componentName":"impactify","disclosureURL":"https://ad.impactify.io/tcfvendors.json"},{"componentType":"bidder","componentName":"imp","aliasOf":"impactify","disclosureURL":null}]})
...
_libraries_metadata_metadata_js__WEBPACK_IMPORTED_MODULE_0__.metadata.register("debugging", {"disclosures":{"https://cdn.jsdelivr.net/gh/prebid/Prebid.js/metadata/disclosures/prebid/debugging.json":{"timestamp":"2026-04-13T18:08:43.251Z","disclosures":[{"identifier":"__*_debugging__","type":"web","purposes":[1]}]}},"components":[{"componentType":"prebid","componentName":"debugging","disclosureURL":"https://cdn.jsdelivr.net/gh/prebid/Prebid.js/metadata/disclosures/prebid/debugging.json"}]})
...
_libraries_metadata_metadata_js__WEBPACK_IMPORTED_MODULE_0__.metadata.register("prebid-core", {"disclosures":{"https://cdn.jsdelivr.net/gh/prebid/Prebid.js/metadata/disclosures/prebid/probes.json":{"timestamp":"2026-04-13T18:08:43.248Z","disclosures":[{"identifier":"_rdc*","type":"cookie","maxAgeSeconds":10,"cookieRefresh":false,"purposes":[1]},{"identifier":"prebid.cookieTest","type":"web","purposes":[1]}]},"https://cdn.jsdelivr.net/gh/prebid/Prebid.js/metadata/disclosures/prebid/debugging.json":{"timestamp":"2026-04-13T18:08:43.248Z","disclosures":[{"identifier":"__*_debugging__","type":"web","purposes":[1]}]}},"components":[{"componentType":"prebid","componentName":"fpdEnrichment","disclosureURL":"https://cdn.jsdelivr.net/gh/prebid/Prebid.js/metadata/disclosures/prebid/probes.json"},{"componentType":"prebid","componentName":"storage","disclosureURL":"https://cdn.jsdelivr.net/gh/prebid/Prebid.js/metadata/disclosures/prebid/probes.json"},{"componentType":"prebid","componentName":"debugging","disclosureURL":"https://cdn.jsdelivr.net/gh/prebid/Prebid.js/metadata/disclosures/prebid/debugging.json"}]})
