...
const helpers = {
  ...
  getViewability(bid) {
    ...
    if (!element) return;
    const viewabilityAmount = (0,_libraries_percentInView_percentInView_js__WEBPACK_IMPORTED_MODULE_12__.isViewabilityMeasurable)(element) ? (0,_libraries_percentInView_percentInView_js__WEBPACK_IMPORTED_MODULE_12__.getViewability)(element, (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_6__.getWindowTop)(), size) : 'na';
  ...
  createOrtbImpVideoObj(bid) {
    var _bid$sizes;
    const videoContext = (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_3__["default"])(bid, 'mediaTypes.video.context');
    const playerSize = (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_3__["default"])(bid, 'mediaTypes.video.playerSize') || ((_bid$sizes = bid.sizes) === null || _bid$sizes === void 0 ? void 0 : _bid$sizes[0]);
...
function createOpenRtbRequest(validBidRequests, bidderRequest) {
  ...
  // Set buyer uid
  (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_4__.dset)(request, 'user.buyeruid', (0,_src_utils_js__WEBPACK_IMPORTED_MODULE_6__.generateUUID)());
